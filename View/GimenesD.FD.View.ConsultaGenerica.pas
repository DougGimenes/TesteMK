unit GimenesD.FD.View.ConsultaGenerica;
...
type
  ...
  public
    ...
    constructor Create(AOwner: TComponent; AConexao: TFDConnection); overload;
  end;
...
constructor TFrmConsultaBase.Create(AOwner: TComponent; AConexao: TFDConnection);
begin
...
begin
  ...
  Self.QryConsulta.FilterOptions := [foCaseInsensitive];
